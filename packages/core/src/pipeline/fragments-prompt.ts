...
export function buildFragmentsBlock(items: EligibleFragment[]): string {
  ...
  return [
    ...
    '- Фрагмент, помеченный «(уже использован ранее)», можно взять повторно, если раньше он хорошо заходил и снова идеально к месту — но один и тот же фрагмент не стоит пускать в дело больше двух-трёх раз за всё время.',
