...
export async function loadUniverseContext(universeIds: number[]): Promise<UniverseContext> {
  ...
  const blendPreamble = 'СМЕШЕНИЕ ВСЕЛЕННЫХ: эта история намеренно объединяет несколько вселенных, перечисленных ниже, — это настоящий кроссовер, а не одна «домашняя» вселенная с гостями из остальных. Ниже дан полный список персонажей всех этих вселенных — выбирай из него свободно, исходя из того, что лучше служит именно этой истории: нормально, если получится 3 персонажа из одной вселенной и 0 из другой — решай по сюжету, а не по квоте «поровну». Но не скатывайся в обычный однотипный сюжет с одним гостем «для галочки»: смешение вселенных — это повод для по-настоящему яркой, волшебной, приключенческой истории, не ограничивай себя масштабом и правилами одной вселенной.'
